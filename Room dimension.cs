...
namespace Room_dimensions
{
    class Program
    {
        static void Main(string[] args)
        {
            /// Requirements:
            /// - Floor area
            /// - Amount of paint - average coverage is 10m²/l [www.diy.com/help-advice/wall-painting-calculator/Dev_npcart_100008.art]
            /// - Volume of room
            ...
            // Amount of paint
            // Assume only walls and ceiling being painted
            // Surface area = 2h (l + w) + lw

            float surfaceArea = (2 * h) * (l + w) + l * w;
            float paintNeeded = surfaceArea / 10;
            Console.Write("Amount of paint needed is ");
            Console.ForegroundColor = ConsoleColor.Red;
